...
def create_layout(app):
    return html.Div(
        [
            ...
            [
                #Título
                html.H4(["Topology Editor"], className="subtitle"),
                ...
                [
                    ...
                    html.Div(
                    [
                        html.H6(["Topology"], className="subtitle padded"),
                        dcc.Upload(id='topology_TE', children = html.Div([html.A('Select or Drag File')]),),
                ...
                [
                    html.Div(
                    [
                        html.H6("Topology Graphical Editor", className="subtitle padded"),
                    ...
                    [   
                        #Titulo da Tabela                             
                        html.Div([html.H6('Network Parameters')], id='properites-title_TE', className='subtitle padded'),
                        #Tabela com Dados
