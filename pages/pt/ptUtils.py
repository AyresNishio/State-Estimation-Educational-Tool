            ...
            html.Div(
                [
                    ...
                    html.A(
                        ...
                        html.Button("Baixar Exemplos", id='btn_download_examples', style={"margin-top": "25px", "margin-left": "5px"}), dcc.Download(id="download_examples")
                    ,],
                    style={
                                            "display": "inline-block",
                                            #"width": "50%",
...
def get_menu():
    menu = html.Div(
        [
            dcc.Link(
                "Visão Geral da Ferramenta Educacional",
                href="/dash/pt/overview",
                className="tab first",
            ),
            dcc.Link(
                "Editor de Topologia",
                href="/dash/pt/topology-editor",
                className="tab",
            ),
            dcc.Link(
                "Fluxo de Potência",
            ...
            dcc.Link(
                "Estimador de Estado para Distribuição",
                href="/dash/pt/DSSE",
                className="tab",
            ),
        ],
